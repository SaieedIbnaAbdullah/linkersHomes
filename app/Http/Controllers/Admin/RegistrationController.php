...
class RegistrationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->show_form = config('cms.registration.showForm');
        $this->show_full_form = config('cms.registration.showFullForm');
        if(auth()->check()) {
            if (auth()->user()->type == 4) {
    ...
    public function show($id)
    {
        ...
        if (request()->has('full') && request()->get('full') == true) {
            ...
            $form_groups = json_decode(json_encode($this->show_full_form));
        } else {
            $form_groups = json_decode(json_encode($this->show_form));
        }
        $code = Registration::findOrFail($id)->reg_code;
        return view('admin.registration.show', compact('form_data', 'form_groups', 'code'));
    }
    ...
    public function round($id,$status)
    {
        ...
        $user = User::find($registration->user_id);
            ...
            if (config('cms.registration.sms')) {
                try {
                    if($registration->round==0){
                         $body = "Congratulation, You Are Cancel from Waiting For Upazila Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==1){
                         $body = "Congratulation, You Are Waiting For Upazila Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==2){
                             $body = "Congratulation, You Are Selected For Upazila Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==3){
                         $body = "Congratulation, You Are Waiting For District Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==4){
                         $body = "Congratulation, You Are Selected For District Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==5){
                         $body = "Congratulation, You Are Waiting For Division Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==6){
                         $body = "Congratulation, You Are Selected For Division Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==7){
                         $body = "Congratulation, You Are Waiting For National Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==8){
                         $body = "Congratulation, You Are Selected For National Round, Thanks by Team PKCSBD";
                    }
                    if($registration->round==9){
                         $body = "Congratulation, You Are Waiting For National Finalist, Thanks by Team PKCSBD";
                    }
                    if($registration->round==10){
                         $body = "Congratulation, You Are Selected For National Finalist, Thanks by Team PKCSBD";
                    }
    ...
    public function approve($id)
    {
        ...
        if ($registration->notified == 0 && $registration->type == 2) {
            $district = GeoDistrict::find($registration->geo_district_id);
            $registration->reg_code = $district->code . $registration->code;
        }
    ...
    public function showProfile()
    {
        ...
        return view('admin.registration.profile_show', compact('form_data', 'form_groups', 'code'));
    }
    ...
    public function registeredProfile()
    {
        ...
        unset($this->full_form_groups[5]);
        $form_groups = json_decode(json_encode($this->full_form_groups));
        return view('admin.registration.profile', compact('form_data', 'form_groups', 'registration'));
    }
    ...
    {
        return Excel::download(new RegistrationExport(), 'registrations' . time() . '.xlsx');
    }
