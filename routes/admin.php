...
Route::prefix('admin')->middleware(['auth'])->name('admin.')->namespace('Admin')->group(function () {
    ...
    // registration routes...
    Route::get('registration-export', 'RegistrationController@export')->name('registration.export');
    Route::resource('registration', 'RegistrationController');
    Route::get('registration/{id}/approve', 'RegistrationController@approve')->name('registration.approve');
    Route::get('registration/{id}/{status}/round', 'RegistrationController@round')->name('registration.round');
    Route::get('registered-profile', 'RegistrationController@registeredProfile');
    Route::get('show-profile', 'RegistrationController@showProfile');
    ...
    Route::get('registration-delete/{id}', 'RegistrationController@delete')->name('registration.delete');
});
