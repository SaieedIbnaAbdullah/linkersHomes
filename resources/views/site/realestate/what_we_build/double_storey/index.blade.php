...
<div>
		...
		<div class="dublex-bannar">
			...
			<h1 class="text-position bannar-text ">Our Duplex Range</h1>

			<h5 class="text2-position bannar-text ">Click below for more information on our Duplex range</h5>
				...
				<div class="col-md-12 duplex-photo-section">
					...
					<div class="row single-storey-photo-section-main" style="margin-top: 3%;">
						...
						<div class="col-md-6 w-100 p-3">
							...
							<a href="{{route('double-storey-list.show',$data->id)}}">
