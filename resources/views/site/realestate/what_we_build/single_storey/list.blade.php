						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="" style="width: 100%">
  									...
  									<div class="card-body">
    									<a href="{{route('singleStoreyProductDetails.show',$data->id)}}" style="text-decoration: none; color: red;">
    										<h6>{{$data->title}}</h6>
    									</a>
    									<div class="col-md-12" style="margin-left: -3%;">
    										<div class="row">
    											...
    											<div class="col-md-2">
    												<a href="{{route('singleStoreyProductDetails.show',$data->id)}}" style="text-decoration:none;" class="btn btn-primary">Details</a>
    											</div>
    										</div>
    									</div>
  									</div>
