              ...
              @foreach($datas as $data)
                <div class="col-md-4">
                  <div class="" style="width: 100%">
                    ...
                    <div class="card-body">
                      <a href="{{route('grannyFlat-product-details.show',$data->id)}}" style="text-decoration: none; color: black;font-weight: bold;" onMouseOver="this.style.color=' #FF0000'" onMouseOut="this.style.color='#000000'" >
                      ...
                      <div class="col-md-12" style="margin-left: -3%;">
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <a href="{{route('grannyFlat-product-details.show',$data->id)}}" style="text-decoration:none;" class="btn btn-primary">Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
