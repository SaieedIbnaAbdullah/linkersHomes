...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{$slider->image}}" alt="" style="height: 600px;">
    </div>
    @endforeach
  </div>
...
<div style="margin-top: 5%; margin-bottom: 5%;">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="">
                    <img src="/site/realestate/images/bannar/8.jpg" style="width: 100%;height: 100%;">
                </a>    
            ...
            <!-- <div class="col-md-1"></div> -->
            <div class="col-md-4">
                <img src="/site/realestate/images/bannar/5.jpg" style="width: 100%;height: 100%;">
                <div class="centere" style="color: white;">
                    <h4>Duplex</h4>
                </div>
            </div>
            <!-- <div class="col-md-1"></div> -->
            <div class="col-md-4">
                <img src="/site/realestate/images/bannar/7.jpg" style="width: 100%;height: 100%;">
                <div class="centere" style="color: white;">
                    <h4>House & Land</h4>
                </div>
            </div>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="row aboutUs-main" style="margin-bottom: 80px;padding-right: 8%; padding-left: 8%">
                    ...
                    <div class="col-md-3 p-0 director">
                        <img src="/site/realestate/images/About-us/14991252759-rsc.jpg" style="height: 285px;width: 285px;" class="image">
                        <div class="overlay">
                            <div class="text">
                    ...
                    <div class="col-md-3 p-0 director">
                        <img src="/site/realestate/images/About-us/14991251661-rsc.jpg" style="height: 285px;width: 285px;" class="image">
                        <div class="overlay">
                            <div class="text">
                    ...
                    <div class="col-md-3 p-0 director">
                        <img src="/site/realestate/images/About-us/14991254575-rsc.jpg" style="height: 285px;width: 285px;" class="image">
                        <div class="overlay">
                            <div class="text">
                    ...
                    <div class="col-md-3 p-0 director">
                        <img src="/site/realestate/images/About-us/14991253721-rsc.jpg" style="height: 285px;width: 285px;" class="image">
                        <div class="overlay">
                            <div class="text">
    ...
    <div class="col-lg-12" style="background-color:  #ff0000;">
        ...
        <div class="col-lg-12" >
            <div class="row content"  style="margin-top: 80px;">
                <div class="col-md-4">
                    <div >
                        <img src="/site/realestate/images/icon1.png" class="front-logo">
                    </div>
                ...
                <div class="col-md-4">
                    <div >
                        <img src="/site/realestate/images/icon2.png" class="front-logo">
                    </div>
                ...
                <div class="col-md-4">
                    <div >
                        <img src="/site/realestate/images/icon3.png" class="front-logo">
                    </div>
                    <h5 class="icon mt-2 mb-1"> Linkers Homes Online Client Portal</h5>
                    <p class="paragraph">Keep up to date on your build progress. Access online 24/7 to view all documentation, progress photos or ask any questions.</p>
                </div>
...
<div>
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-3">
                <div class="w-100 p-3">
                    <img class="card-img-top size" src="/site/realestate/images/Website-thumbnail-350x250.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                <div class="w-100 p-3">
                    <img class="card-img-top size" src="/site/realestate/images/849modern_design_house_with_sepratestaircase_front_elevation_L.jpg" alt="Card image cap">
                    <!-- <time datetime="September 20, 2018"><i class="fa fa-calendar" aria-hidden="true"></i>
                    September 20, 2018</time> -->
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="w-100 p-3" >
                    <img class="card-img-top size" src="/site/realestate/images/35_lakhs_construction_cost_4_cents_duplex_building_in_bhimavaram-2_4094445.jpg" alt="Card image cap">
                    <!-- <time datetime="September 20, 2018"><i class="fa fa-calendar" aria-hidden="true"></i>
                    September 20, 2018</time> -->
                    <div class="card-body">
