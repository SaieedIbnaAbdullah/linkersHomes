...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="/images/slider/5.jpg" alt="First slide" style="height: 600px;">
    </div>
    <div class="carousel-item">
    	<a href="{{route('promotions.show')}}">
...
<div class="what-build" >
	...
	<div class="col-md-12" style="background-color: red;padding-top: 20px;padding-bottom: 30px;">
		<div class="row" style="margin-bottom: 40px;padding-right: 8%; padding-left: 8%; margin-top: 30px;">
			...
			<div class="col-md-3">
				<a href="{{route('duplex.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Duplex</h5>
				</a>		
			</div>
			<div class="col-md-3"  style="background-color: red;padding: 2px;">
				<a href="{{route('custom.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Custom Designs</h5>
				</a>		
			</div>
			<div class="col-md-3" >
				<a href="{{route('granny-flat.show')}}" style="text-decoration:none;color:white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Granny Flat</h5>
				</a>	
			</div>

			<div class="col-md-3" >
				<a href="{{route('house-granny.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
		...
		<div class="row" style="margin-bottom: 40px;padding-right: 8%; padding-left: 8%; margin-top: 30px;">
			...
			<div class="col-md-3">
				<a href="{{route('knock-down-rebuild.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Knock Down Rebuild</h5>
				</a>		
			</div>
			<div class="col-md-3"  style="background-color: red;padding: 2px;">
				<a href="{{route('multi-dwelling.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Multi Dwelling</h5>
				</a>		
			</div>
			<div class="col-md-3" >
				<a href="{{route('single-storey.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Single Storey</h5>
				</a>	
			</div>

			<div class="col-md-3" >
				<a href="{{route('double-storey.show')}}" style="text-decoration:none;color: white;text-align-last:center;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'">
					<h5>Double Storey</h5>
				</a>	
			</div>
