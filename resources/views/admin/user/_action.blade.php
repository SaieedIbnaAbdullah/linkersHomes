<a style="z-index: 99999999; margin-bottom: 3px;" href="{{ url('/admin/registration?created_by=' . $data->id) }}" class="btn btn-primary icon-btn text-white">
    <i style="margin-top: -5px; margin-right: 0;" class="fa fa-list fa-2x"></i>
</a>
