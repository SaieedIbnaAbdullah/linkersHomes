                ...
                <div class="col-md-8 offset-md-2 mt-3">
                    <form v-on:submit.prevent="submitForm()" id="create_form">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12" v-if="formData.type==5">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span v-bind:style="{ width: prependWidth + 'px' }" class="input-group-text">Select Group</span>
                                    </div>
                                    <select v-model="formData.group_select" id="type" name="group_select" class="form-control">
                                ...
                                <label v-if="errors.group_select" class="help-block text-danger" style="margin-top: 3px; margin-bottom: 0; padding: 0;">
                                    @{{ errors.group_select[0] }}
                                </label>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="input-group">
