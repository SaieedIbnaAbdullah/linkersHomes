...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.registration.index', ['filter' => request()->get('filter')]) }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View Registration List</a>
    </div>
@stop
