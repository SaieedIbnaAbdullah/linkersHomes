        ...
        <div class="card-header">
            ...
            @if(!(request()->has('created_by') && request()->get('created_by') != ''))
                @if(auth()->user()->type == 0 || auth()->user()->type == 2)
                    <a href="{{ url('admin/registration-export') . '?' . http_build_query(request()->query()) }}" class="btn btn-primary icon-btn text-white pull-right ml-2"><i class="fa fa-download"></i>Download Data</a>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="round" value="{{ request()->get('round') }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="display: block;" for="geo_union_id">Field Admin</label>
                                                <input id="field_admin_id" name="field_admin_id" class="form-control" type="text" placeholder="Enter field admin id">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="display: block;" for="reg_type">Registration Type</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="display: block;" for="reg_type">Group Select</label>
                                                 <select  id="type" name="group_select" class="form-control">
                                                    <option value="">Select group</option>
                                                    <option value="Group A (Class 6 + 7)">Group A (Class 6 + 7)</option>
                                                    <option value="Group B (Class 8 + 9 + 10)">Group B (Class 8 + 9 + 10)</option>
                                                    <option value="Group C (Class 11 + 12)">Group C (Class 11 + 12)</option>
                                                </select>
                                            </div>
                                        </div>
